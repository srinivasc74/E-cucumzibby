...
import static com.zibby.auto.ComparatorAdapter.TOSTRING_CASE_INSENSITIVE_ORDER;
...
public final class Configuration {
	...
	public static final BrowserTypes BROWSER = BrowserTypes.CHROME;

	public static final String EXECUTION_ENVIRONMENT = "QA";
	...
	// public static final boolean SUPPRESS_SCREENSHOT =
	// peek(ConfigurationKeys.SUPPRESS_SCREENSHOT, true);

	// public static final Optional<String> SPLUNK_FILE =
	// peekOpt(ConfigurationKeys.SPLUNK_FILE);
