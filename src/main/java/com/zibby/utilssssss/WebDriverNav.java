package com.anthem.utilities;

import com.anthem.auto.WebDriverUtil;
 ...
 * one clicks on a link that opens a new tab. Feel free to add any other methods
 * for other browsers as needed
 */
public class WebDriverNavigation {
    ...
    public static void navigateToPortalClearingCookies(String portal) {
        ...
        WebDriverNavigation.navigateToURL(DataMaps.dataMap.get(portal));
    }
